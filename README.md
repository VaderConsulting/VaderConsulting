...
| [Context-Sensitive-Help](https://github.com/VaderConsulting/Context-Sensitive-Help) | Chips, Bits and Bytes VB6 demo (`CS Help.exe` / `CS Help.vbp`): TreeView that shows context-sensitive popup. | VB6 | 2026-08-27 |
...
| [Cpu](https://github.com/VaderConsulting/Cpu) | Chips, Bits and Bytes VB6 always-on-top CPU meter: reads Win9x `HKEY_DYN_DATA\PerfStats` `KERNEL\CPUUsage` on. | VB6 | 2026-08-27 |
...
| [Create-Users](https://github.com/VaderConsulting/Create-Users) | CSC VB6 bulk AD user provisioner (`CreateUsers.exe` / `CreateUsers.vbp`): reads pending rows from. | VB6 | 2026-08-27 |
| [Createas](https://github.com/VaderConsulting/Createas) | DAGS VB6 "create as" installer helper: picks an `.msi` (or other app) and runs it under alternate credentials. | VB6 | 2026-08-27 |
...
| [FileSplitter](https://github.com/VaderConsulting/FileSplitter) | VB6 File Splitter (`FileSplitter.exe`, VersionCompanyName Makino) that splits a file into sized parts (KB or. | VB6 | 2026-08-27 |
| [FileTransfer](https://github.com/VaderConsulting/FileTransfer) | VB6 binary file-copy experiment (`FileTransfer`) whose `TFileCopy` helper streams a source to a destination. | VB6 | 2026-08-27 |
| [findandreplace](https://github.com/VaderConsulting/findandreplace) | VB-Helper FindAndReplace sample (Rocky Mountain Computer Consulting; `FindAndReplace.exe`) that walks a. | VB6 | 2026-08-27 |
...
| [Fixurl](https://github.com/VaderConsulting/Fixurl) | Tiny VB6 URL decoder (`Project1` / Fixurl) that turns percent-encoded text in `txtURL1` into a readable URL. | VB6 | 2026-08-27 |
...
| [Helper](https://github.com/VaderConsulting/Helper) | VB6 Installation Helper Windows service host (`Helper.exe` / service name `InstallationHelper`) built with. | VB6 | 2026-08-27 |
...
| [ID-Cards](https://github.com/VaderConsulting/ID-Cards) | Chips Bits Bytes VB6 HMAS ARUNTA pass printer for gangway/visitor barcodes via barpic.ocx. | VB6 | 2026-08-27 |
| [Idle-Time](https://github.com/VaderConsulting/Idle-Time) | VB6 Idle Time utility (`IdleTime`, VersionCompanyName Freelance) that uses `GetLastInputInfo` on a timer to. | VB6 | 2026-08-27 |
...
| [Import-Users](https://github.com/VaderConsulting/Import-Users) | CSC VB6 CSV importer that loads Same-As user rows into SQL POLICE tblCreateUsers. | VB6 | 2026-08-27 |
...
| [ini_editor](https://github.com/VaderConsulting/ini_editor) | LenSoft Inc. VB6 INI reader/editor sample (`ini reader.vbp`; form shipped as `ini reader.frm.example`) for. | VB6 | 2026-08-27 |
| [INIEditor](https://github.com/VaderConsulting/INIEditor) | Ali Ezzahir's VB6 INI Editor (`INIEDITOR.exe`) that opens `.ini` files, lists sections and keys, and supports. | VB6 | 2026-08-27 |
| [inifiletotreeview](https://github.com/VaderConsulting/inifiletotreeview) | Mirant VB6 sample that loads a `.ini` into a TreeView (sections as parents, keys as children) with. | VB6 | 2026-08-27 |
...
| [ScriptingDemo](https://github.com/VaderConsulting/ScriptingDemo) | VB6 Scripting Control Demo (`ScriptingDemo`) that hosts `msscript.ocx` to load and run VBScript samples. | VB6 | 2026-08-27 |
...
| [UpdateTrendGUID](https://github.com/VaderConsulting/UpdateTrendGUID) | VB6 UpdateTrendGUID (`UpdateTrendGUID.exe`) that creates a new GUID and writes it to Trend Micro PC-cillin NT. | VB6 | 2026-08-27 |
...
| [Vb4kix](https://github.com/VaderConsulting/Vb4kix) | VB6 VB4Kix (`VB4Kix`) host with a `modKix` module that mirrors KiXtart-style helpers. | VB6 | 2026-08-27 |
| [VBsax2jumpstart](https://github.com/VaderConsulting/VBsax2jumpstart) | Microsoft SAX2 Jump Start sample (`VBSAXExample.exe`) that parses an XML file with MSXML `SAXXMLReader` and. | VB6 | 2026-08-27 |
...
| [Wait](https://github.com/VaderConsulting/Wait) | Dave Scarmozzino / TheScarms.com sample (`Wait.exe` / `WaitforApp`) that shells an application and blocks. | VB6 | 2026-08-27 |
| [watchdir](https://github.com/VaderConsulting/watchdir) | Southern Cross Software VB6 directory watcher (`WATCHDIR.VBP`) that uses `FindFirstChangeNotification` /. | VB6 | 2026-08-27 |
...
| [WinLogon-Notification](https://github.com/VaderConsulting/WinLogon-Notification) | VB6 ActiveX DLL (`Notification` / `drNotification`) that defines the Winlogon `WLX_NOTIFICATION_INFO`. | VB6 | 2026-08-27 |
...
| [Word](https://github.com/VaderConsulting/Word) | VB6 Word Property Search (`WordProp.exe` / `prjWordProperties`) that walks a folder for `*.doc` (filterable). | VB6 | 2026-08-27 |
| [WordCounter](https://github.com/VaderConsulting/WordCounter) | VB6 Word Counter (`WordCounter.exe`) that reads a text file, tokenizes words into a list, and can write the. | VB6 | 2026-08-27 |
...
| [XP-Style](https://github.com/VaderConsulting/XP-Style) | VB6 XP Style helper (`XP Style.vbp`) that writes an application `.exe.manifest` so Windows XP+ draws common. | VB6 | 2026-08-27 |
